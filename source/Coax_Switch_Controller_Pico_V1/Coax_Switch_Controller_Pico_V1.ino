/*
 ...
 ( )( )(  _)(__ \(_  ) (  ) (_  )   / ) ( )( )(  ) (__ \(  )( \/\/ )
  ...
  Smart Controller for remote antenna switch (Ameritron or similar), Version 1.
  Designed to be run on a Raspberry Pi Pico. Developed in Arduino IDE.
  VE2ZAZ/VA2IW, July 2023. https://ve2zaz,net
...
void config_Outputs()
{
  ...
  {   // Yes
    ...
    if (num_channels = 8) pinMode(Relay_H, OUTPUT);       //    " 
  ...
  if (Serial.available())                                                         // Data available in USB serial port buffer?
  {
    ...
    if (charact == '\n')                                                          // is command line completely received (line feed character)?
    {
      ...
      {                                                                                                 // Yes
        ...
        Serial.println("D: Sets the delay on the Transmit Delay output, from 0 to 100");
